...
/**
    ...
    protected function ajax_layered_nav_dropdown( $terms, $taxonomy, $query_type, $show_count ) {
         $found = false;
    ...
    protected function ajax_layered_nav_list( $terms, $taxonomy, $query_type, $show_count ) {
        $found = false;
    ...
    protected function ajax_layered_nav_checkbox( $terms, $taxonomy, $query_type, $show_count ) {
         $found = false;
    ...
    protected function ajax_layered_nav_sizeselector( $terms, $taxonomy, $query_type, $labels, $show_count ) {
        $found = false;
    ...
    protected function ajax_layered_nav_colorpicker( $terms, $taxonomy, $query_type, $colors, $show_count ) {
        $found = false;
	...
	function widget( $args, $instance ) {
		...
		/* List of Checkboxes */
	   	  case "checkbox":
			    $found = $this->ajax_layered_nav_checkbox($terms, $taxonomy, $query_type, $show_count);			
		        break;
          case "dropdown":
                $found = $this->ajax_layered_nav_dropdown($terms, $taxonomy, $query_type, $show_count);
                break;
                     
		      /*Regular List of Terms*/
		  case "list":
              $found = $this->ajax_layered_nav_list($terms, $taxonomy, $query_type, $show_count);
		      break;
					/* Size Labels */
		  case "sizeselector":
              $found = $this->ajax_layered_nav_sizeselector($terms, $taxonomy, $query_type, $labels, $show_count);
		      break;
					/* Color Boxes*/
		  case "colorpicker":
              
              $found = $this->ajax_layered_nav_colorpicker($terms, $taxonomy, $query_type, $colors, $show_count);
 ...
 // class SOD_Widget_Ajax_Layered_Nav
    ...
    protected function get_filtered_term_product_counts( $term_ids, $taxonomy, $query_type ) {
        ...
        $sql  = "
            SELECT COUNT( {$wpdb->posts}.ID ) as term_count, 
            term_count_relationships.term_taxonomy_id as term_count_id 
            FROM {$wpdb->posts}
            INNER JOIN {$wpdb->term_relationships} AS term_count_relationships 
            ON ({$wpdb->posts}.ID = term_count_relationships.object_id)
