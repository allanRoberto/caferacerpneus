 ...
 */
class FG_Magento_to_WooCommerce {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      FG_Magento_to_WooCommerce_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 * - FG_Magento_to_WooCommerce_Admin. Defines all hooks for the admin area.
	 * - FG_Magento_to_WooCommerce_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
//		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-fg-magento-to-woocommerce-public.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new FG_Magento_to_WooCommerce_Admin( $this->get_plugin_name(), $this->get_version() );
		...
		$this->loader->add_action( 'fgm2wc_post_empty_database', $plugin_admin, 'delete_woocommerce_data', 10 );
		$this->loader->add_action( 'admin_footer', $plugin_admin, 'display_notices', 20 );
		$this->loader->add_action( 'wp_ajax_fgm2wc_import', $plugin_admin, 'ajax_importer' );
...
//		$plugin_public = new FG_Magento_to_WooCommerce_Public( $this->get_plugin_name(), $this->get_version() );
//
...
//		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'enqueue_scripts' );
	 ...
	 *
	 * @since     1.0.0
	 * @return    FG_Magento_to_WooCommerce_Loader    Orchestrates the hooks of the plugin.
	 */
