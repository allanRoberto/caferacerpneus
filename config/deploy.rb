...
set :application, "caferacerpneus" #FIXME
...
set :scm, :git
set :repository,  "git@github.com:allanRoberto/caferacerpneus.git" #FIXME
# set :scm, :subversion
...
set :local_path, "/Users/Allan/sites/caferacerpneus" #FIXME
...
set :local_domain, 'caferacerpneus.art.com.br' #FIXME
